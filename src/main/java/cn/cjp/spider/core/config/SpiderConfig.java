            ...
            for (File configFile : configFiles) {
                ...
                if (configFile.getName().endsWith(PARSE_RULE_FILE_SUFFIX)) {
                    ...
                    if (LOGGER.isDebugEnabled()) {
                        LOGGER.debug(String.format("read parse rule[%s]: %s", parseRuleModel.getRuleName(), JacksonUtil.toJson(parseRuleModel)));
                    }
                    ...
                    if (LOGGER.isDebugEnabled()) {
                        LOGGER.debug(String.format("read parse rule[%s]: %s", pageModel.getSiteName(), JacksonUtil.toJson(pageModel)));
                    }
